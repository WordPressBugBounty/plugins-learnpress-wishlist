...
class WishList {
  ...
  addOrRemove(args) {
    ...
    _utils_js__WEBPACK_IMPORTED_MODULE_0__.lpSetLoadingEl(elBtn, 1);
    _utils_js__WEBPACK_IMPORTED_MODULE_0__.lpShowHideEl(icon, 0);
    ...
    const callBack = {
      success: response => {
        ...
        if (status === 'success') {
          ...
          _lpToastify__WEBPACK_IMPORTED_MODULE_1__.show(message, status);
      ...
      error: error => {
        _lpToastify__WEBPACK_IMPORTED_MODULE_1__.show(error, 'error');
      },
      completed: () => {
        _utils_js__WEBPACK_IMPORTED_MODULE_0__.lpShowHideEl(icon, 1);
        _utils_js__WEBPACK_IMPORTED_MODULE_0__.lpSetLoadingEl(elBtn, 0);
      }
    };
...
/******/ })()
;
//# sourceMappingURL=lp-wishlist.js.map